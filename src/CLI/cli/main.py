...
from cli.registration import add_registration_parser
from cli.registration import do_registration
from cli.enclave import add_enclave_parser
from cli.enclave import do_enclave
...
def create_parser(prog_name):
    ...
    add_registration_parser(subparsers)
